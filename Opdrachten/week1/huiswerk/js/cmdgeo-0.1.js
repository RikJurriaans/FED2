...
(function() {
    ...
    // deze heb je altijd nodig en mag maar 1 instantie van zijn. Althans dat slaat ergens op.
    function Debug() {
        return {
    ...
    // Alle geometrische functie bij elkaar in de functie Geom. Wederom een singleton
    function Geom() {
        return {
    ...
    function Geo() {
        ...
        // Het afvangen in de constructor zetten dan hoef ik geen 2 functiecalls te maken.
        Debug.debug_message("Controleer of GPS beschikbaar is...");
        ...
        return {
            ...
            _check_locations: function(event){
                // Deze tering zooi is niet te redden. Kost me teveel tijd en is buiten de scope van de opdracht.
